            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <div class="input-group date ">
                        <input type="text" name="nombre" class="form-control datetimepicker-input">
                        @error('nombre')
                    ...
                    <div class="input-group date ">
                        <input type="text" name="descuento" class="form-control datetimepicker-input">
                        @error('descuento')
                            <span style="display: block" class="error invalid-feedback ">
                                {{ $message }}
                            </span>
                    ...
                    <div class="form-group mt-2">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="fechas" class="form-control float-right" id="reservation">
                        </div>
                    </div>

                    <div class="form-group mt-5">
                        <input class="mt-5" type="checkbox" name="my-checkbox" id="check" checked
