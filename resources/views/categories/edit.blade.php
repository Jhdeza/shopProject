                                ...
                                <div class="container">
                                    <div class="form-group">
                                        ...
                                        <input id="name" class="form-control " name="name" type="text"
                                            placeholder="{{ __('main.name') }}" value="{{ $category->name }}">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <input @checked(old('is_sub', $category->parent_id)) type="checkbox" name="is_sub"
                                            id="is_sub" value="1" />
                                    ...
                                    <div id="cat-cont" class="form-group">
                                        ...
                                        <select class="form-control" name="parent_id">
                                            ...
                                            @foreach ($categories as $categ)
                                                <option
                                                    {{ $categ->id == $category->parent_id ? 'selected = "selected"' : '' }}
