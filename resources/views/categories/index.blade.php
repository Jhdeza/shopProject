    ...
    <section class="content">
        <div class="card mt-5">
            <div class="card-header">
                ...
                <button class="btn btn-success btn-sm float-right btn-modal" data-toggle="modal" data-target="#modal-generic" data-url="{{ route('category.create') }}">
                    <i class="fas fa-list-alt "> </i> @lang('main.create')
                </button>
            </div>
            <div class="card-body">
                <table id="categories-tb" class="table table-striped table-list" style="width: 100%" data-del_title="{{__('main.sure_delete_cat')}}">
                    <thead>
                        <tr>
                            <th></th>
                            <th >{{__('main.name')}}</th>
